...
if page == TRANS["nav_manual"]:
    ...
    with tab6:
        ...
        **2. ค่าพลังงานคืออะไร:**  ค่า W/L คือตัวบอกว่า ในน้ำ 1 ลิตร มีพลังงานอยู่กี่วัตต์
        **3. การใช้ปริมาณน้ำเยอะ:** ถัง >190L ใช้เพียง 5.3 W/L ก็จะเกิด Cavitation ทั่วถึง
